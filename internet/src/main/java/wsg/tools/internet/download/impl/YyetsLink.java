 ...
 * @since 2020/12/6
 */
public class YyetsLink extends AbstractLink implements FilenameSupplier, LengthSupplier {
    ...
    public static YyetsLink of(String title, String url) throws InvalidResourceException {
        ...
        return new YyetsLink(title, matcher.group("name"), Long.parseLong(matcher.group("size")), matcher.group("hash"));
    }

...
public enum RegionEnum implements TextSupplier, TitleSupplier, AkaPredicate<String> {
    ...
    OTH("Others", "其他"),
    CN("China", "中国", new String[]{"中国大陆", "大陆", "中华人民共和国"}),
    US("United States", "美国", new String[]{"USA"}),
    GB("United Kingdom", "英国", new String[]{"UK"}),
    JP("Japan", "日本", new String[]{"日本国"}),
    HK("Hong Kong SAR China", "中国香港特别行政区", new String[]{"Hong Kong", "中国香港", "香港", "中国（香港）"}),
    TW("Taiwan", "台湾", new String[]{"中国台湾", "中国（台湾）", "中国台湾省"}),
    MO("Macau SAR China", "中国澳门特别行政区", new String[]{"中国澳门", "中国（澳门）"}),
    KR("South Korea", "韩国", new String[]{"韩国韩国网络", "大韩民国"}),

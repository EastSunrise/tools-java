 ...
 * @since 2020/9/18
 */
public class Ed2kResource extends AbstractResource implements FilenameSupplier, LengthSupplier {
    ...
    public static Ed2kResource of(String title, @Nonnull String url) throws InvalidResourceException {
        if (!StringUtils.startsWithIgnoreCase(url, ED2K_PREFIX)) {
            throw new UnknownResourceException(Ed2kResource.class, title, url);
        }
        url = url.replace(" ", "");
        ...
        throw new InvalidResourceException(Ed2kResource.class, title, url);
    }
